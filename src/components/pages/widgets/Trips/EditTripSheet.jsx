...
const EditTripSheet = ({ trip, onClose, onUpdate }) => {
  ...
  // helper: format datetime for input[type=datetime-local] (LOCAL time, not UTC)
  ...
  useEffect(() => {
    ...
    // Format startDate & endDate (for <input type="datetime-local" />) in local time
    if (trip.startDate) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Combine petrol & CNG if fuelType is "Petrol & CNG"
